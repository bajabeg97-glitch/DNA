...
> → download). Izvor se nikad ne menja; ne-READY akcije se ne mogu označiti.
> HTTP e2e: 5 poziva (A01 solo → sty; A02 solo → mixed; par → 2 artefakta).
> npm 14/14; Python 102 + 5. Evidence: `artifacts-max-4.62/bridge-run.json`;
