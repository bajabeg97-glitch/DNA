...
_NAME_HINTS = {
    ...
    "percussion": ("perc", "perkus", "udaral"),
    "bass": ("bass", "bas"),
    "guitar": ("guitar", "gitara", "gtr"),
    "solo": ("solo", "lead", "melody", "melodija", "vocal"),
    "pad": ("pad", "strings", "string", "podloga"),
    "riff": ("riff", "phrase", "fraza"),
}

_PA800_TRACK = {
    "drums": "drum", "percussion": "perc", "bass": "bass",
    "guitar": "acc1", "harmony": "acc1", "accompaniment": "acc2",
    "riff": "acc3", "melody": "acc3", "solo": "acc4", "pad": "acc5",
    "unknown": None,
}
...
def _normalize_factory_role(value: object) -> str | None:
    ...
    aliases = {
        ...
        "melody": "melody", "solo": "solo", "lead": "solo", "riff": "riff",
        "power-riff": "riff", "pad": "pad", "strings": "pad",
    }
...
def _infer_role(
    *, channel: int, family: str, stats: Mapping[str, Any], track_name: str,
    ...
    family_role = {
        "guitar": "guitar", "bass": "bass", "synth-pad": "pad",
        "ensemble": "pad", "strings": "pad", "percussive": "percussion",
        "chromatic-percussion": "percussion", "synth-lead": "solo",
        "reed": "melody", "pipe": "melody", "brass": "melody",
        "ethnic": "melody",
    }.get(family)
    if family_role:
    ...
    for identity in identities:
        ...
        for channel in channels:
            ...
            for binding in bindings:
                ...
                segment = {
                    "segmentId": f"{identity.track_uid}-ch{channel + 1}-{binding.start_tick}",
